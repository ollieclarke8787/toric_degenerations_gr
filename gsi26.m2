...
R = QQ[p_(1, 2), p_(1, 3), p_(1, 4), p_(1, 5), p_(1, 6), p_(2, 3), p_(2, 4), p_(2, 5), p_(2, 6), p_(3, 4), p_(3, 5), p_(3, 6), p_(4, 5), p_(4, 6), p_(5, 6)];
S = QQ[x_(1,1) .. x_(k, n)];
...
monomialMapList = {
map(S,R, {x_(1,1)*x_(2,2), x_(1,1)*x_(2,3), x_(1,1)*x_(2,4), x_(1,1)*x_(2,5), x_(1,1)*x_(2,6), x_(1,2)*x_(2,3), x_(1,2)*x_(2,4), x_(1,2)*x_(2,5), x_(1,2)*x_(2,6), x_(1,3)*x_(2,4), x_(1,3)*x_(2,5), x_(1,3)*x_(2,6), x_(1,4)*x_(2,5), x_(1,4)*x_(2,6), x_(1,5)*x_(2,6)}),
map(S,R, {-x_(1,2)*x_(2,1), -x_(1,3)*x_(2,1), -x_(1,4)*x_(2,1), -x_(1,5)*x_(2,1), -x_(1,6)*x_(2,1), x_(1,2)*x_(2,3), x_(1,2)*x_(2,4), x_(1,2)*x_(2,5), x_(1,2)*x_(2,6), x_(1,3)*x_(2,4), x_(1,3)*x_(2,5), x_(1,3)*x_(2,6), x_(1,4)*x_(2,5), x_(1,4)*x_(2,6), x_(1,5)*x_(2,6)}),
map(S,R, {x_(1,1)*x_(2,2), -x_(1,3)*x_(2,1), -x_(1,4)*x_(2,1), -x_(1,5)*x_(2,1), -x_(1,6)*x_(2,1), -x_(1,3)*x_(2,2), -x_(1,4)*x_(2,2), -x_(1,5)*x_(2,2), -x_(1,6)*x_(2,2), x_(1,3)*x_(2,4), x_(1,3)*x_(2,5), x_(1,3)*x_(2,6), x_(1,4)*x_(2,5), x_(1,4)*x_(2,6), x_(1,5)*x_(2,6)}),
map(S,R, {x_(1,1)*x_(2,2), x_(1,1)*x_(2,3), -x_(1,4)*x_(2,1), -x_(1,5)*x_(2,1), -x_(1,6)*x_(2,1), x_(1,2)*x_(2,3), -x_(1,4)*x_(2,2), -x_(1,5)*x_(2,2), -x_(1,6)*x_(2,2), -x_(1,4)*x_(2,3), -x_(1,5)*x_(2,3), -x_(1,6)*x_(2,3), x_(1,4)*x_(2,5), x_(1,4)*x_(2,6), x_(1,5)*x_(2,6)}),
map(S,R, {x_(1,1)*x_(2,2), x_(1,1)*x_(2,3), x_(1,1)*x_(2,4), -x_(1,5)*x_(2,1), -x_(1,6)*x_(2,1), x_(1,2)*x_(2,3), x_(1,2)*x_(2,4), -x_(1,5)*x_(2,2), -x_(1,6)*x_(2,2), x_(1,3)*x_(2,4), -x_(1,5)*x_(2,3), -x_(1,6)*x_(2,3), -x_(1,5)*x_(2,4), -x_(1,6)*x_(2,4), x_(1,5)*x_(2,6)}),
map(S,R, {x_(1,1)*x_(2,2), x_(1,1)*x_(2,3), x_(1,1)*x_(2,4), x_(1,1)*x_(2,5), -x_(1,6)*x_(2,1), x_(1,2)*x_(2,3), x_(1,2)*x_(2,4), x_(1,2)*x_(2,5), -x_(1,6)*x_(2,2), x_(1,3)*x_(2,4), x_(1,3)*x_(2,5), -x_(1,6)*x_(2,3), x_(1,4)*x_(2,5), -x_(1,6)*x_(2,4), -x_(1,6)*x_(2,5)})
};
...
f = "Degenerated Opposite Schubert Ideals Gr(2,6) MAIN Output";
f << "----Toric Ideals----" << endl;
...
f = "Degenerated Opposite Schubert Ideals Gr(2,6) Indices Output";
f << "----Toric Ideals----" << endl;
i = 0;

...
R = QQ[p_(1, 2), p_(1, 3), p_(1, 4), p_(1, 5), p_(2, 3), p_(2, 4), p_(2, 5), p_(3, 4), p_(3, 5), p_(4, 5)];
...
monomialMapList = {
map(S,R, {x_(1,1)*x_(2,2), x_(1,1)*x_(2,3), x_(1,1)*x_(2,4), x_(1,1)*x_(2,5), x_(1,2)*x_(2,3), x_(1,2)*x_(2,4), x_(1,2)*x_(2,5), x_(1,3)*x_(2,4), x_(1,3)*x_(2,5), x_(1,4)*x_(2,5)}),
map(S,R, {-x_(1,2)*x_(2,1), -x_(1,3)*x_(2,1), -x_(1,4)*x_(2,1), -x_(1,5)*x_(2,1), x_(1,2)*x_(2,3), x_(1,2)*x_(2,4), x_(1,2)*x_(2,5), x_(1,3)*x_(2,4), x_(1,3)*x_(2,5), x_(1,4)*x_(2,5)}),
map(S,R, {x_(1,1)*x_(2,2), -x_(1,3)*x_(2,1), -x_(1,4)*x_(2,1), -x_(1,5)*x_(2,1), -x_(1,3)*x_(2,2), -x_(1,4)*x_(2,2), -x_(1,5)*x_(2,2), x_(1,3)*x_(2,4), x_(1,3)*x_(2,5), x_(1,4)*x_(2,5)}),
map(S,R, {x_(1,1)*x_(2,2), x_(1,1)*x_(2,3), -x_(1,4)*x_(2,1), -x_(1,5)*x_(2,1), x_(1,2)*x_(2,3), -x_(1,4)*x_(2,2), -x_(1,5)*x_(2,2), -x_(1,4)*x_(2,3), -x_(1,5)*x_(2,3), x_(1,4)*x_(2,5)}),
map(S,R, {x_(1,1)*x_(2,2), x_(1,1)*x_(2,3), x_(1,1)*x_(2,4), -x_(1,5)*x_(2,1), x_(1,2)*x_(2,3), x_(1,2)*x_(2,4), -x_(1,5)*x_(2,2), x_(1,3)*x_(2,4), -x_(1,5)*x_(2,3), -x_(1,5)*x_(2,4)})
};
...
f = "Degenerated Richardson Ideals Gr(2,5) MAIN Output";
f << "----Toric Ideals----" << endl;
...
f = "Degenerated Richardson Ideals Gr(2,5) Indices Output";
f << "----Toric Ideals----" << endl;

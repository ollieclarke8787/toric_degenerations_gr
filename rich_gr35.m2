...
R = QQ[p_(1, 2, 3), p_(1, 2, 4), p_(1, 2, 5), p_(1, 3, 4), p_(1, 3, 5), p_(1, 4, 5), p_(2, 3, 4), p_(2, 3, 5), p_(2, 4, 5), p_(3, 4, 5)];
S = QQ[x_(1,1) .. x_(k, n)];
...
monomialMapList = {
map(S,R, {x_(1,1)*x_(2,2)*x_(3,3), x_(1,1)*x_(2,2)*x_(3,4), x_(1,1)*x_(2,2)*x_(3,5), x_(1,1)*x_(2,3)*x_(3,4), x_(1,1)*x_(2,3)*x_(3,5), x_(1,1)*x_(2,4)*x_(3,5), x_(1,2)*x_(2,3)*x_(3,4), x_(1,2)*x_(2,3)*x_(3,5), x_(1,2)*x_(2,4)*x_(3,5), x_(1,3)*x_(2,4)*x_(3,5)}),
map(S,R, {-x_(1,2)*x_(2,1)*x_(3,3), -x_(1,2)*x_(2,1)*x_(3,4), -x_(1,2)*x_(2,1)*x_(3,5), -x_(1,3)*x_(2,1)*x_(3,4), -x_(1,3)*x_(2,1)*x_(3,5), -x_(1,4)*x_(2,1)*x_(3,5), x_(1,2)*x_(2,3)*x_(3,4), x_(1,2)*x_(2,3)*x_(3,5), x_(1,2)*x_(2,4)*x_(3,5), x_(1,3)*x_(2,4)*x_(3,5)}),
map(S,R, {x_(1,1)*x_(2,2)*x_(3,3), x_(1,1)*x_(2,2)*x_(3,4), x_(1,1)*x_(2,2)*x_(3,5), -x_(1,3)*x_(2,1)*x_(3,4), -x_(1,3)*x_(2,1)*x_(3,5), -x_(1,4)*x_(2,1)*x_(3,5), -x_(1,3)*x_(2,2)*x_(3,4), -x_(1,3)*x_(2,2)*x_(3,5), -x_(1,4)*x_(2,2)*x_(3,5), x_(1,3)*x_(2,4)*x_(3,5)}),
map(S,R, {x_(1,1)*x_(2,2)*x_(3,3), x_(1,1)*x_(2,2)*x_(3,4), x_(1,1)*x_(2,2)*x_(3,5), x_(1,1)*x_(2,3)*x_(3,4), x_(1,1)*x_(2,3)*x_(3,5), -x_(1,4)*x_(2,1)*x_(3,5), x_(1,2)*x_(2,3)*x_(3,4), x_(1,2)*x_(2,3)*x_(3,5), -x_(1,4)*x_(2,2)*x_(3,5), -x_(1,4)*x_(2,3)*x_(3,5)}),
map(S,R, {x_(1,1)*x_(2,2)*x_(3,3), x_(1,1)*x_(2,2)*x_(3,4), x_(1,1)*x_(2,2)*x_(3,5), x_(1,1)*x_(2,3)*x_(3,4), x_(1,1)*x_(2,3)*x_(3,5), x_(1,1)*x_(2,4)*x_(3,5), x_(1,2)*x_(2,3)*x_(3,4), x_(1,2)*x_(2,3)*x_(3,5), x_(1,2)*x_(2,4)*x_(3,5), x_(1,3)*x_(2,4)*x_(3,5)})
};
...
f = "Degenerated Richardson Ideals Gr(3,5) MAIN Output";
f << "----Toric Ideals----" << endl;
...
f = "Degenerated Richardson Ideals Gr(3,5) Indices Output";
f << "----Toric Ideals----" << endl;
